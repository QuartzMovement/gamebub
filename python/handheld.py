...
class TLV320DAC3101:
    ...
    def setup(self) -> None:
        ...
        self._write_reg(0x3F, 0xD4)

        # DAC Left gain = -50 dB
        self._write_reg(0x41, 0b1011_1010)
        # DAC Right gain = -50 dB
        self._write_reg(0x42, 0b1011_1010)

        # Unmute DAC left and right channels
        self._write_reg(0x40, 0x00)

        # Enable headphone detection
        self._write_reg(0x43, 0x80)
        # (handheld.dac._read_reg(0x43) >> 5) & 0b11
